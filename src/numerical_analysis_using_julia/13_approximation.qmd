...
- $C_{[a,\,b]}$ 가 내적벡터공간이기 때문에 선형대수학에의 중요한 개념인 벡터, 선형독립, 기저, 내적, 직교 와 같은 개념을 그대로 쓸 수 있다. 
...
![르장드르 다항식](ch13_approximations/fig-Legendre_polynoimal.png){#fig-legendre_polynomials width=300}
...
$$
\langle P_n(x),\, P_m(x) \rangle = \dfrac{2}{2n+1}\delta_{ij}
$$
...
![Chevyshev 다항식](ch13_approximations/fig-Chevyshev_polynoimal.png){#fig-chevyshev_polynomials width=300}
