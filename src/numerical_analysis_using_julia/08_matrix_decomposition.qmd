...
[삼중대각행렬](04_matrix_algebra.qmd#sec-pseudodiagonal_matrix) 을 하쌍대각행렬 $\boldsymbol{L}$ 과 대각성분이 모두 $1$ 인 상쌍대각행렬 $\boldsymbol{U}$ 의 곱으로 분해하는 것을 크라우트 분해라고 한다. 

$$
\boldsymbol{A} =\begin{bmatrix} A_{11} & A_{12} & 0 &  \cdots & \cdots &\cdots & 0 \\
A_{21} & A_{22} & A_{23} & 0 & \cdots & \cdots& 0 \\
0 & A_{32} & A_{33} & A_{34} & 0 & \cdots & 0 
\vdots & 0 & \ddots & \end{bmatrix}
$$
