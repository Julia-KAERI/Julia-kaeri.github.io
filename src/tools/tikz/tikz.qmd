...
![tikz 예시 1](tikz_test/test01.png){#fig-tikz0_test01 width=500}
...
![tikz 예시 2](tikz_test/test02.png){#fig-tikz0_test02 width=250}
...
![tikz 예시 3](tikz_test/test03.png){#fig-tikz0_test03 width=200}
...
![tikz 예시 4](tikz_test/test04.png){#fig-tikz0_test04 width=200}
...
\end{document}
```
![tikz 예시 5](tikz_test/test05.png){#fig-tikz0_test05 width=200}
...
![tikz 예시 6](tikz_test/test06.png){#fig-tikz0_test06 width=300}
