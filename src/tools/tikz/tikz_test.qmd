...
\draw[color=black, domain=-1:0, variable = \t]   plot ({\t}, {(1+\t)});
\draw[color=black, domain=0:1, variable = \t]   plot ({\t}, {(1-\t)});
...
\draw[color=black, domain=-5:5, samples=100, variable = \t]   plot ({\t}, { (2 * sin((\t * 180 / pi) /2)/((\t)))^2 });
\end{scope}
